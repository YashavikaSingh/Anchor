...
const DB_CONNECTION_STRING = 'mongodb+srv://anchorTeam:<Dv7D7azMAYvWKsqb>@cluster0.pqgux6v.mongodb.net/youtube_tracker?retryWrites=true&w=majority';
...
app.post('/videos', async (req, res) => {
  try {
    ...
    res.status(201).json({ message: 'Video data saved successfully', videoId: video._id });
  } catch (error) {
